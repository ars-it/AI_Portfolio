...
export function Presentation() {
  ...
  const profile = {
    ...
    description:
      "Hey 👋\nI'm Aravind S, a Software Engineer with 3+ years of experience building scalable microservices and backend solutions. I'm passionate about AI/ML, backend development with Java and Spring Boot, and creating systems that make a real impact.",
    src: '/avatar-aravind.jpg',
    fallbackSrc:
    ...
    <div className="mx-auto w-full max-w-5xl py-6 font-sans">
      <div className="grid grid-cols-1 items-center gap-10 md:grid-cols-2">
        ...
        <div className="flex flex-col space-y">
          ...
          >
            {['Full Stack Development', 'AI/ML', 'Next.js', 'Spring Boot', 'Microservices', 'Python', 'TypeScript'].map(
              (tag) => (
                <span
                  key={tag}
